...
public class DevicePolicyDemoActivity extends Activity implements
	...
	public void onClick(View v) {
		...
		case R.id.button_lock_device:
			if(toogleBtnStatus.equals(true))
			{
			// We lock the screen
			...
			{
				Toast.makeText(this, "Please activate the devcie policy by clicking on the first button.", Toast.LENGTH_LONG).show();
			}
			break;
